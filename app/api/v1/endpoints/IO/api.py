...
remove_image, download_image, get_image_info, archive, update_dataset
...
router.include_router(update_dataset.router, prefix="/dataset", tags=["dataset"])
...
router.include_router(archive.router, prefix="/archive", tags=["archive"]) # Подключаем